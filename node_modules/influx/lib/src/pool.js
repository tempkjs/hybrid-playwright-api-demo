...
class Pool {
    ...
    stream(options, callback) {
        ...
        const _a = (host.options || {}), { headers: _ignoredHostHeaders } = _a, hostReqOptions = __rest(_a, ["headers"]);
        const req = request(Object.assign({ headers: mergedHeaders, hostname: host.url.hostname, method: options.method, path, port: Number(host.url.port), protocol: host.url.protocol, timeout: this._timeout }, hostReqOptions), once((res) => {
